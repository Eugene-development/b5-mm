	...
	<div class="relative z-10 mx-auto max-w-xl">
		...
		<div class="group relative">
			...
			>
				{#if successMessage}
					<div
						class="mb-6 flex items-center gap-3 rounded-xl border border-emerald-500/20 bg-emerald-500/10 p-4"
					>
						<div
		...
		<p class="mx-8 mt-6 text-center text-sm text-slate-500">
			Клиент должен быть осведомлён о том, что в ближайшее время с ним свяжутся специалисты компании
			Новострой
		</p>
	</div>
</div>
